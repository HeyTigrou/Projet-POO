...
namespace ProjetPOO {
	...
	public ref class StockSearchDelete : public System::Windows::Forms::Form
	{
	public:
		StockSearchDelete(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->buttonConfirm->Click += gcnew System::EventHandler(this, &StockSearchDelete::buttonConfirm_Click);
			// 
			// buttonCancel
			// 
			...
			this->buttonCancel->Click += gcnew System::EventHandler(this, &StockSearchDelete::buttonCancel_Click);
			// 
			// textBoxFinalChoice
			// 
			...
			this->buttonSearch->Click += gcnew System::EventHandler(this, &StockSearchDelete::buttonSearch_Click);
			// 
			// textBoxSearch
			// 
			...
			this->Name = L"StockSearchDelete";
			this->Text = L"Recherche de l\'article à supprimer";
			this->Load += gcnew System::EventHandler(this, &StockSearchDelete::StockSearchDelete_Load);
...
#pragma endregion
		...
		Void buttonConfirm_Click(System::Object^ sender, System::EventArgs^ e) 
		{
			...
			if (this->textBoxFinalChoice->Text != "")
			{
				...
				StockDelete^ nextForm = gcnew StockDelete(idPerson);
				this->Hide();
				nextForm->ShowDialog();
				this->Close();
			}
		...
		Void StockSearchDelete_Load(System::Object^ sender, System::EventArgs^ e) 
		{
